...
const Footer: React.FC = () => {
  return (
    <footer className="bg-zinc-900 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-700 py-8">
      ...
      {/* Bottom Copyright */}
      <div className="mt-8 border-t border-neutral-200 dark:border-neutral-700 pt-6 text-center text-sm text-neutral-600 dark:text-neutral-400">
        © {new Date().getFullYear()} John Lloyd Glee. All rights reserved.
      </div>
    </footer>
  );
};
