...
export default function Home() {
  return (
    ...
    <section id="skills" className="py-8 pt-8 flex flex-col md:flex-row items-center">
        ...
        <p className="mt-4">This portfolio showcases a collection of my most impactful projects and highlights my skills and experience in Web development. Here you'll find examples of my work. I'm passionate about creating user-friendly interfaces, crafting compelling narratives, developing innovative solutions, and I strive to bring that passion to every project I undertake. I&aposm constantly learning and evolving my skillset, and this portfolio reflects that growth. I hope you enjoy exploring my work and gain a better understanding of what I can offer.</p>
