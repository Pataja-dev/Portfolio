  ...
  return (
    ...
    <section id="home" className="py-10 pb-12 flex flex-col md:flex-row ">
          ...
          <div className="md:w-1/2 md:pl-7 mt-8 md:mt-0 pt-52 pb-16  bg-stone-200  rounded-lg  justify-center h-full">
            <h1 className="text-7xl pr-0 font-bold text-center">John Lloyd Glee</h1>
            <p className="mt-4 text-center font-bold pt-32">Tito Solutions Intern Software Developer</p>
            <div className="justify-self-center  h-0.5 bg-gray-950 w-96 mt-0"></div>
    ...
    <section id="project" className="py-20">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <p className="text-lg text-gray-700">Learning Management for Alternative Learning System of Sison District in Pangasinan II District V
        </p>
      </div>
    </section>
...
{/* Thank you */}
    ...
    <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <p className="text-light mb-5 text-justify text-gray-700 pl-96 pr-96">I'd love to connect with you! Whether you have a specific project in mind, are interested in collaborating, or simply want to learn more about my work, please don't hesitate to reach out.</p>
      </div>
      <div className="ml-[500px]" >
      <ul>
        <li className="text-left pt-4">+63-951-352-0909</li>
        <li className="text-left pt-3">www.johnlloydglee.com</li>
        <li className="text-left pt-3">johnlloydglee26@gmail.com</li>
        <li className="text-left pt-3">Lambingan St., Floridablanca, Pampanga</li>
      </ul>
      </div>
